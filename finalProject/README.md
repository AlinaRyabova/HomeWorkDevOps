...
Ця команда видалить усі ресурси, створені за допомогою Terraform. Зверніть увагу, що це включає S3-бакет і DynamoDB-таблицю, які зберігають стан Terraform.
